 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       10000        // (mA) RMS current. Multiply by 1.414 for peak current. 800
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_CURRENT     600//450
